  ...
  return (
    ...
    <Grid p='20px' templateColumns='repeat(2, 1fr)' gap={6}>
      <Box>
        ...
        <Input onChange={(e)=>setFullName(e.target.value)} mt='8px' placeholder='Enter First and Last Name' />
      </Box>
      
      <Box>
        <Text as="b">Email Address</Text>
        <Input  onChange={(e)=>setEmail(e.target.value)} mt='8px' placeholder='name@abc.com' />
      </Box>
      ...
      <Box>
        ...
        <Input  onChange={(e)=>setPhNum(e.target.value)}  type='tel' placeholder='phone number' />
        </InputGroup>
      </Box>
    </Grid>

    <Box p='20px'>
      <Button onClick={()=>setConBtn(!conBtn)} h='50px' w='220px' bg='#1ab64f' color='white' size='md'>Continue</Button>
    </Box>
